	...
	ui := &Ui{
		MainMenu: MainMenu{
			...
			StartButton: &Button{
				...
				Handler:  startButton,
				Offset:   pixel.V(percentW(0), percentH(20)),
				Scale:    2,
				Corner:   TL,
				Hovering: false,
				Rect:     &pixel.Rect{},
			...
			OptionsButton: &Button{
				...
				Handler:  nil,
				Offset:   pixel.V(percentW(0), percentH(20)+mMYOffset+5),
				Scale:    2,
				Corner:   TL,
				Hovering: false,
				Rect:     &pixel.Rect{},
			...
			AboutButton: &Button{
				...
				Handler:  nil,
				Offset:   pixel.V(percentW(0), percentH(20)+mMYOffset*2+10),
				Scale:    2,
				Corner:   TL,
				Hovering: false,
				Rect:     &pixel.Rect{},
			...
			ExitButton: &Button{
				...
				Handler:  exitButton,
				Offset:   pixel.V(percentW(0), percentH(20)+mMYOffset*3+15),
				Scale:    2,
				Corner:   TL,
				Hovering: false,
				Rect:     &pixel.Rect{},
